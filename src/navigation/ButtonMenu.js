...
const Item = ({item, handlePress}) => {
  ...
  return (
    <TouchableOpacity onPress={() => handlePress(item.title)} style={itemStyle}>
...
const ButtonMenu = ({visible = false, close}) => {
  return (
    <BottomSheet isVisible={visible} containerStyle={styles.container}>
      <View
        style={[
          styles.innerContainer,
          Platform.OS === 'ios' ? {marginBottom: 17} : {marginBottom: 21},
        ]}>
